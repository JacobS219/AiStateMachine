...
public class DroneBadCode : MonoBehaviour
{
            ...
            case DroneState.Wander:
                {
                    ...
                    {
                        _target = targetToAggro.GetComponent<DroneBadCode>();
    ...
    private Transform CheckForAggro()
    {
        ...
        for (var i = 0; i < 24; i++)
        {
            ...
            {
                var drone = hit.collider.GetComponent<DroneBadCode>();
                if (drone != null && drone.Team != gameObject.GetComponent<DroneBadCode>().Team)
                {
